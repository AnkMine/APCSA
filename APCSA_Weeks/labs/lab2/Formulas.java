public class Formulas {
    ...
    public void areaCircle(double r) {
        ...
        System.out.println("\n\tThe area of a circle with radius " + r + " is " + makeBold(area + "") + ".");
    }
    ...
    public void volCylinder(double r, double h) {
        ...
        System.out.println("\n\tThe volume of a cylinder with radius " + r + " and height " + h + " is " + makeBold(volume + "") + ".");
    }
    ...
    public void volSphere(double r) {
        ...
        System.out.println("\n\tThe volume of a sphere with radius " + r + " is " + makeBold(volume + "") + ".");
    }
    ...
    public void areaTrapezoid(double a, double b, double h) {
        ...
        System.out.println("\n\tThe area of a trapezoid with bases " + a + " and " + b + " and height " + h + " is " + makeBold(area + "") + ".");
    }
    ...
    public void pythagThm(double a, double b) {
        ...
        System.out.println("\n\tThe hypotenuse of a right triangle with leg lengths " + a + " and " + b + " is " + makeBold(c + "") + ".");
    }
    ...
    public void distanceForm(double x1, double y1, double x2, double y2) {
        ...
        System.out.println("\n\tThe distance between points (" + x1 + ", " + y1 + ") and (" + x2 + ", " + y2 + ") is " + makeBold(d + "") + ".");
    }
    ...
    public void quadraticForm(double a, double b, double c) {
        ...
        if (discriminant >= 0) {
            ...
            if (root1 == root2) {
                System.out.println("\n\tThe quadratic equation with coefficients a=" + a + ", b=" + b + ", c=" + c + " has one solution: x = " + makeBold(root1 + "") + ".");
            } else {
                System.out.println("\n\tThe quadratic equation with coefficients a=" + a + ", b=" + b + ", c=" + c + " has solutions x = " + makeBold(root1 + "") + " and x = " + makeBold(root2 + "") + ".");
            }
        } else {
            ...
            System.out.println("\n\tThe quadratic equation with coefficients a=" + a + ", b=" + b + ", c=" + c + " has complex solutions x = " + makeBold(root1) + " and x = " + makeBold(root2) + ".");
        }
    }
    ...
    public void slopeLine(double x1, double y1, double x2, double y2) {
        ...
        System.out.println("\n\tThe slope of the line passing through (" + x1 + ", " + y1 + ") and (" + x2 + ", " + y2 + ") is " + makeBold(m + "") + ".");
    }
    ...
    public void lawCos(double a, double b, double theta) {
        ...
        System.out.println("\n\tThe third side of a triangle with sides " + a + " and " + b + " and an included angle of " + theta + " degrees is " + makeBold(c + "") + ".");
    }
    ...
    public void gravPotenEnergy(double m, double h) {
        ...
        System.out.println("\n\tThe gravitational potential energy of an object with mass " + m + " kg at a height of " + h + " meters is " + makeBold(pe + "") + " Joules.");
    }
    ...
    public void weight(double m) {
        ...
        double w = m * gravity;
        System.out.println("\n\tThe weight of an object with mass " + m + " kg is " + makeBold(w + "") + " Newtons.");
    }
    ...
    public void kineticEnergy(double m, double v) {
        ...
        System.out.println("\n\tThe kinetic energy of an object with mass " + m + " kg moving at " + v + " m/s is " + makeBold(ke + "") + " Joules.");
    }
    ...
    public void newtonSecondLaw(double m, double a) {
        ...
        double f = m * a;
        System.out.println("\n\tThe force on an object with mass " + m + " kg accelerating at " + a + " m/s^2 is " + makeBold(f + "") + " Newtons.");
    }
    ...
    public void OhmLaw(double i, double r) {
        ...
        double v = i * r;
        System.out.println("\n\tThe voltage across a circuit with current " + i + " Amps and resistance " + r + " Ohms is " + makeBold(v + "") + " Volts.");
    }
